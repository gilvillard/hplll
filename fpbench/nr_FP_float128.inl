...
// FROM SHI BAI FPLLL BRANCH // Jeu 13 déc 2018 16:03:27 CET

/****************************
 *  F=__float128 specialization
 ****************************/

// TO CHECK OR RELOAD FROM SHI BAI BRANCH 
// SEE GV COMMENTS BELOW 
...
//#include "../defs.h"  GV LOCAL 
//#include "nr_FP.inl"  GV LOCAL 
...
template<>
inline unsigned int FP_NR<__float128>::get_prec() {return 113;} // GV PUT !! 113 {return PREC_FLOAT128;}
