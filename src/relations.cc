...
FPTuple<ZT, FT>::relation_f(ZZ_mat<mpz_t>& C, long alpha,
...
template<class ZT, class FT>  int
FPTuple<ZT, FT>::relation_f_z(ZZ_mat<mpz_t>& C, ZZ_mat<mpz_t> A,  int alpha,
                              long confidence_gap, long shift, long increment,
                              int lllmethod, double delta) {
...
template<class ZT, class FT>  int
FPTuple<ZT, FT>::detect_lift_f_z(ZZ_mat<ZT>& U, ZZ_mat<mpz_t> L_in, ZZ_mat<FT> A_in_f, int& new_def, int def,
...
FPTuple<ZT, FT>::relation_z(ZZ_mat<mpz_t>& C,  long alpha,
	...
	found = relation_lll_z(C, L, alpha, confidence_gap, shift, truncate, lllmethod, delta);
...
template<class ZT, class FT>  int
FPTuple<ZT, FT>::relation_lll_z(ZZ_mat<mpz_t>& C, ZZ_mat<mpz_t> A, long alpha,
                                long confidence_gap, long shift, int truncate, int lllmethod, double delta) {
