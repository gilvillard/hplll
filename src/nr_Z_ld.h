/****************************
 *  Z= long double specialization
 ****************************/

#ifndef HPLLL_NR_Z_LD_H
#define HPLLL_NR_Z_LD_H
...
template<>
inline Z_NR<long double>::Z_NR() {}

template<>
inline Z_NR<long double>::Z_NR(const Z_NR<long double>& z) : data(z.data) {}
...
/** comparison */
template<>
inline int Z_NR<long double>::cmp(const Z_NR<long double>& m) const {
...
/** operator */
template<>
inline void Z_NR<long double>::operator=(const Z_NR<long double>& a) {
  data = a.data;
}

template<>
inline void Z_NR<long double>::operator=(long a) {
  data = static_cast<long double>(a);
}

template<>
inline bool Z_NR<long double>::operator<(const Z_NR<long double>& a) const {
  return data < a.data;
}
...
template<>
inline bool Z_NR<long double>::operator==(long a) const {
  return data == static_cast<long double>(a);
}
...
/** arithmetic */
template<>
inline void Z_NR<long double>::add(const Z_NR<long double>& a, const Z_NR<long double>& b) {
  data = a.data + b.data;
}
...
template<>
inline void Z_NR<long double>::sub(const Z_NR<long double>& a, const Z_NR<long double>& b) {
  data = a.data - b.data;
}
...
template<>
inline void Z_NR<long double>::mul_si(const Z_NR<long double>& a, long int b) {
  data = a.data * static_cast<long double>(b);
}
...
template<>
inline void Z_NR<long double>::mul_2si(const Z_NR<long double>& a, long b) {
  data = ldexp(a.data, b);
}
...
template<>
inline void Z_NR<long double>::addmul_si(const Z_NR<long double>& a, long b) {
  data += a.data * static_cast<long double>(b);
}

template<>
inline void Z_NR<long double>::submul(const Z_NR<long double>& a, const Z_NR<long double>& b) {
  data -= a.data * b.data;
}
...
template<>
inline void Z_NR<long double>::abs(const Z_NR<long double>& a) {
  data = a.data;
  if (data < 0) data = -data;
}
...
//GV
// additional cf Z_misc

template<> template<>
inline void Z_NR<long double>::set_f(const FP_NR<long double>& a) {
  data = a.get_data();
}
