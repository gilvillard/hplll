...
int main(int argc, char *argv[])  {
  ...
  Lattice<mpz_t, mpfr_t,  matrix<Z_NR<mpz_t> >, matrix<FP_NR<mpfr_t> > > Btest(B,NO_TRANSFORM,DEF_REDUCTION);
  Btest.isreduced(0.9);
  ...
  */
  ...
  double tt;
  tt=((double) thlll)/((double) tl1);

  cout << endl; 
  cout << "Dim: " << d << "   " << "Bit size: " << atoi(argv[decal+2]) << endl; 
  cout << "Ratio " << tt << endl; 
