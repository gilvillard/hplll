...
int main(int argc, char *argv[])  {
  ...
  //lehmer_lll<__int128_t, double, matrix<FP_NR<double> > > (C, A, delta, 30, true,8);
  //lehmer_lll<mpz_t, double, matrix<FP_NR<double> > > (C, A, delta, 50, false,4);
  //lehmer_lll<mpz_t,dpe_t, MatrixPE<double, dpe_t> > (C, A, delta, 100, false,4);
  lehmer_lll<long, double, matrix<FP_NR<double> > > (C, A, delta, 30,true,8);
