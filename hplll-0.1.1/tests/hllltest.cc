...
int main(int argc, char *argv[])  {
  ...
  Lattice<integer_t, dpe_t, MatrixZT, MatrixPE<double, dpe_t> >  B2(B1.getbase(),NO_TRANSFORM,DEF_REDUCTION);
  B2.hlll(delta);
  ...
  Lattice<integer_t, ldpe_t, MatrixZT, MatrixPE<long double, ldpe_t> >  B4(B3.getbase(),NO_TRANSFORM,DEF_REDUCTION);
  B4.hlll(delta);
...
//  -------------------- TEST i --------------------------------
  ...
  Lattice<integer_t, dpe_t, MatrixZT, MatrixPE<double, dpe_t> > B6(B5.getbase(),NO_TRANSFORM,DEF_REDUCTION);
  ...
  //  *****************************************************  
  cout << endl << "     " <<  succeed << " hlll tests ok over " << nbtest << endl << endl; 
  //  *****************************************************  
