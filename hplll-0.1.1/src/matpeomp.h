...
#ifndef HPLLL_MATPEOMP_H
#define HPLLL_MATPEOMP_H
...
// MatrixPE gives template<class T> struct colexp
...
template<>  inline void MatrixPE_omp<double,dpe_t>::subcol(const int j, const int k, const int l)  {    
...
template<>  inline void MatrixPE_omp<long double,ldpe_t>::subcol(const int j, const int k, const int l)  {    
...
template<>  inline void MatrixPE_omp<double,dpe_t>::addcol(const int j, const int k, const int l)  {     // j < k 
...
template<>  inline void MatrixPE_omp<long double,ldpe_t>::addcol(const int j, const int k, const int l)  {     // j < k 
...
template<>  inline void MatrixPE_omp<double,dpe_t>::fmasub(const int j, const int k,  
...
template<>  inline void MatrixPE_omp<long double,ldpe_t>::fmasub(const int j, const int k,  
...
template<>  inline void MatrixPE_omp<double,dpe_t>::set(int i, int j, FP_NR<dpe_t> xdpe) { 
...
template<>  inline void MatrixPE_omp<long double,ldpe_t>::set(int i, int j, FP_NR<ldpe_t> xdpe) { 
...
template<>  inline  FP_NR<dpe_t>  MatrixPE_omp<double,dpe_t>::get(int i, int j) { 
...
template<>  inline  FP_NR<ldpe_t>  MatrixPE_omp<long double, ldpe_t>::get(int i, int j) { 
...
template<>  inline FP_NR<dpe_t>   MatrixPE_omp<double, dpe_t>::get_non_normalized(int i, int j) {
...
template<>  inline FP_NR<ldpe_t>   MatrixPE_omp<long double, ldpe_t>::get_non_normalized(int i, int j) { // voir double ou long double 
...
template<>  inline void MatrixPE_omp<double,dpe_t>::submulcol(const int j, const int k,  const  FP_NR<dpe_t> a, const int l)  {     // j < k 
...
template<>  inline void MatrixPE_omp<long double,ldpe_t>::submulcol(const int j, const int k,  const  FP_NR<ldpe_t> a, const int l)  {     // j < k 
...
template<>  inline void MatrixPE_omp<double,dpe_t>::normalize(int j, int nmax)  {  
...
template<>  inline void MatrixPE_omp<long double,ldpe_t>::normalize(int j, int nmax)  {  
...
template<>  inline void MatrixPE_omp<double,dpe_t>::setcol(int j, Z_NR<mpz_t>* b, int beg, int l) {  
...
template<>  inline void MatrixPE_omp<long double,ldpe_t>::setcol(int j, Z_NR<mpz_t>* b, int beg, int l) {  
...
template<>  inline void MatrixPE_omp<double,dpe_t>::setcol(int j, FP_NR<mpfr_t>* b, int beg, int l) {  
...
template<>  inline void MatrixPE_omp<long double, ldpe_t>::setcol(int j, FP_NR<mpfr_t>* b, int beg, int l) {  
...
template<> inline void  MatrixPE_omp<double,dpe_t>::setcol(int j, const FP_NR<dpe_t>* vd, int nmax) {   
...
// From mixed matrices 
template<>  inline void MatrixPE_omp<double, dpe_t>::setcol(int j, const mixed_col<FP_NR<mpfr_t>, Z_NR<mpz_t> > c, int beg, int l) {
...
// From mixed matrices 
template<>  inline void MatrixPE_omp<long double, ldpe_t>::setcol(int j, const mixed_col<FP_NR<mpfr_t>, Z_NR<mpz_t> > c, int beg, int l) {
...
template<> inline void  MatrixPE_omp<long double, ldpe_t>::setcol(int j, const FP_NR<ldpe_t>* vd, int nmax) {   
...
template<> inline void  MatrixPE_omp<double,dpe_t>::div(const int j, const int k,  
...
template<> inline void  MatrixPE_omp<long double, ldpe_t>::div(const int j, const int k,  
...
template<class T, class DPET> void print2maple(MatrixPE_omp<T,DPET> M, int n, int d) 
{
...
template<class T, class DPET> void printcol(MatrixPE_omp<T, DPET> M, int n, int beg, int k=0) 
{
