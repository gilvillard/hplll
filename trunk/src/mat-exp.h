...
#ifndef HPLLL_MATEXP_H
#define HPLLL_MATEXP_H
...
// Comment normaliser zéro ? 

//******** Addition de zéro
//Attention il y avait un bug ds FMA quand on additionne 0 
//le calculdu nouvel exposant peout être faut à cause du dépassement ex 
// Il faut tester zéro : fait dans fma, pas ailleurs (si on suppose 
// par exemple que cela (exposant de zéro pour toute la colonne) ne se produit pas 


// Comme un tableau linéaire de colonnes 

// Template par double ou long double --->****************** à faire dpe double et dpe long double 
// Avec FP_NR<dpe_t>  // meme chose dans hlll 

// Rajouter des normalize après les opérations arithmetique, en global sur un vecteur ? 
// Voir les pts clef au niveau
// étude numérique théorique d'un algo avec cette approche ? 
...
public:
  ...
  matrixexp(int rows, int cols) : n(0), d(0) {
    resize(rows, cols);
  }
...
template<>  inline void matrixexp<double,dpe_t>::subcol(const int j, const int k, const int l)  {    
...
template<>  inline void matrixexp<long double,ldpe_t>::subcol(const int j, const int k, const int l)  {    
...
template<>  inline void matrixexp<double,dpe_t>::addcol(const int j, const int k, const int l)  {     // j < k 
...
template<>  inline void matrixexp<long double,ldpe_t>::addcol(const int j, const int k, const int l)  {     // j < k 
...
template<>  inline void matrixexp<double,dpe_t>::fmasub(const int j, const int k,  
...
template<>  inline void matrixexp<long double,ldpe_t>::fmasub(const int j, const int k,  
...
template<>  inline void matrixexp<double,dpe_t>::set(int i, int j, FP_NR<dpe_t> xdpe) { 
...
template<>  inline void matrixexp<long double,ldpe_t>::set(int i, int j, FP_NR<ldpe_t> xdpe) { 
...
template<>  inline  FP_NR<dpe_t>  matrixexp<double,dpe_t>::get(int i, int j) { 
...
template<>  inline  FP_NR<ldpe_t>  matrixexp<long double, ldpe_t>::get(int i, int j) { 
...
template<>  inline FP_NR<dpe_t>   matrixexp<double, dpe_t>::get_non_normalized(int i, int j) {
...
template<>  inline FP_NR<ldpe_t>   matrixexp<long double, ldpe_t>::get_non_normalized(int i, int j) { // voir double ou long double 
...
template<>  inline void matrixexp<double,dpe_t>::submulcol(const int j, const int k,  const  FP_NR<dpe_t> a, const int l)  {     // j < k 
...
template<>  inline void matrixexp<long double,ldpe_t>::submulcol(const int j, const int k,  const  FP_NR<ldpe_t> a, const int l)  {     // j < k 
...
template<>  inline void matrixexp<double,dpe_t>::normalize(int j, int nmax)  {  
...
template<>  inline void matrixexp<long double,ldpe_t>::normalize(int j, int nmax)  {  
...
template<>  inline void matrixexp<double,dpe_t>::setcol(int j, Z_NR<mpz_t>* b, int beg, int l) {  
...
template<>  inline void matrixexp<long double,ldpe_t>::setcol(int j, Z_NR<mpz_t>* b, int beg, int l) {  
...
template<>  inline void matrixexp<double,dpe_t>::setcol(int j, FP_NR<mpfr_t>* b, int beg, int l) {  
...
template<>  inline void matrixexp<long double, ldpe_t>::setcol(int j, FP_NR<mpfr_t>* b, int beg, int l) {  
...
template<> inline void  matrixexp<double,dpe_t>::setcol(int j, const FP_NR<dpe_t>* vd, int nmax) {   
...
template<> inline void  matrixexp<long double, ldpe_t>::setcol(int j, const FP_NR<ldpe_t>* vd, int nmax) {   
...
template<> inline void  matrixexp<double,dpe_t>::div(const int j, const int k,  
...
template<> inline void  matrixexp<long double, ldpe_t>::div(const int j, const int k,  
...
template<class T, class DPET> void print2maple(matrixexp<T,DPET> M, int n, int d) 
{
...
template<class T, class DPET> void printcol(matrixexp<T, DPET> M, int n, int beg, int k=0) 
{
