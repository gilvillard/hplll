...
int main(int argc, char *argv[])  {
  ...
  nbrel=relations_hjls<mpfr_t,ldpe_t,matrixexp<long double, ldpe_t> >(C,A,nbrel,setprec);
  ...
  nbrel=relations_hjls<mpfr_t, dpe_t,matrixexp<double, dpe_t> >(C,A,nbrel,setprec);
